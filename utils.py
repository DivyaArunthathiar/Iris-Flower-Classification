...
def HandleOutlier(df,  lExclCols=[], pMul=3):
    """
    desc:
        HandleOutlier - removes Outliers from all cols in df except exclCols 
    usage: 
...
def MulCorrCols(dfc, depVars, bVerbose=False, lExclCols=[]):
    """
    returns: 
